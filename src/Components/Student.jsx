...
const saveStudent = () => {
  ...
  return (
    <div className='card'>
          <img src={props.student.images} alt='Titles'className='card-img-top mx-auto' />
          {!editMode && <ul className='list-group list-group-flush'>
            ...
            <button type="button" className="btn btn-danger" onClick={() => props.removeStudent(props.student)}> Delete Title <FontAwesomeIcon icon={faWarning} /></button>
